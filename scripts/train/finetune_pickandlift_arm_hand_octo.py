#!/usr/bin/env python3
"""Fine-tune Octo-base on Franka pick-and-lift arm+hand OXE dataset."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Fine-tune Octo-base on pick-and-lift arm7+hand_synergy_k dataset with "
    ...
    parser.add_argument(
        "--data-dir",
        type=str,
        default="dataset/franka_pickandlift_arm_hand_synergy_k4_owrap20_oxe_20260306",
    ...
    parser.add_argument(
        "--save-dir",
        type=str,
        default="models/pickandlift_arm_hand_octo_overfit_k4_owrap20_20260306",
    ...
    parser.add_argument("--action-dim", type=int, default=11)
